...
s = {alpha0:     0, d1:  0.135, a0:      0,        theta1: theta1,
     alpha1: -pi/2, d2:0.00625, a1:      0, theta2: theta2 - math.pi/2,
     alpha2:     0, d3:      0, a2:  0.411, theta3: theta3 + math.pi/2,
     alpha3:  pi/2, d4:  0.368, a3:      0,        theta4: theta4,
     alpha4: -pi/2, d5:      0, a4:      0,        theta5: theta5,
     alpha5:  pi/2, d6:  0.121, a5:      0,        theta6: theta6,
     alpha6:     0, d7:    0.0, a6:      0,        theta7: 0}
...
px = -0.00428667791374644
py = 0.258835606840153
pz =  0.466983876304506
roll = math.radians(89.87893434791008)
pitch = math.radians(89.88231144120364)
yaw = math.radians(0.03643662760103062)
...
# Rrpy = rot_z(yaw) * rot_y(pitch) * rot_z(roll)
...
L4_5 = s[a3]    # Distance from joint 4 to joint 5 (WC)
...
theta1 = 1.558404489105737
theta2 = -0.5942846103040692
theta3 = 2.1889919478512883
