...
def get_angles(x, y, z, roll, pitch, yaw):
  ...
  # Transpose of R03 NEW
  R03T = Matrix([
    [sin(q2)*cos(q1)*cos(q3) + sin(q3)*cos(q1)*cos(q2), -sin(q1)*sin(q2)*cos(q3) - sin(q1)*sin(q3)*cos(q2), -sin(q2)*sin(q3) + cos(q2)*cos(q3)], 
    [sin(q2)*sin(q3)*cos(q1) - cos(q1)*cos(q2)*cos(q3), -sin(q1)*sin(q2)*sin(q3) + sin(q1)*cos(q2)*cos(q3), sin(q2)*cos(q3) + sin(q3)*cos(q2)], 
    [-sin(q1), -cos(q1), 0]])
